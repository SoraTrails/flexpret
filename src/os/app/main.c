...
// 	th[1] = osThreadNew(cover_main, NULL, &attr[1]);
// 	th[2] = osThreadNew(duff_main, NULL, &attr[2]);
// 	th[3] = osThreadNew(fibcall_main, NULL, &attr[3]);
// 	th[4] = osThreadNew(insertsort_main, NULL, &attr[4]);
// 	th[5] = osThreadNew(lcdnum_main, NULL, &attr[5]);
// 	th[6] = osThreadNew(loop3_main, NULL, &attr[6]);
...
int main() {
	...
	hwthread_start(2, cover_main, NULL);
