...
int main() {
	...
	hwthread_start(3, cover_main, NULL);
	hwthread_start(4, cover_main, NULL);
	hwthread_start(5, cover_main, NULL);
	hwthread_start(6, cover_main, NULL);
    hwthread_start(7, cover_main, NULL);
